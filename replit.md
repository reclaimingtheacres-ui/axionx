...
- **Client review page** (`GET /admin/geoop-import/client-review`): Lists all GeoOp-created client records with job counts and source name variants for audit before relying on them for assignment/statistics. Only shows clients linked via `geoop_source_client_map`.
